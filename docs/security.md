...
- **admin**: may update protected stack resources (e.g. deploy new image versions, scale services). Cannot create or delete protected resources via the external listener.
- **user**: read-only access to protected stack resources. Full access to non-protected resources.
